...
#$ -l h_rt=00:01:00   # job requires up to 24 hours of runtime
...
#$ -F                 # input args
#$ -e /wynton/home/ahituv/fongsl/tools/wynton/log/error.txt
#$ -o /wynton/home/ahituv/fongsl/tools/wynton/log/output.txt
...
date
hostname
python3 fruitlist.py "$1" "$2" $SEED -o ${SEED}_output
